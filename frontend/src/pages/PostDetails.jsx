// import { Footer, Navbar,Comment } from "../index";
...
const PostDetails = () => {
  ...
  const postComment = async (e) => {
    ...
    try {
      ...
      { comment:comment,author:user.username,postId:postId,userId:user._id},{withCredentials:true});
      // console.log(res.data);
      // setComment("")
      // fetchPostComments()
    ...
    <>
      <div>
        ...
        {loader?<div className="h-[80vh] flex justify-center items-center w-full"><Loader/></div>:<div className="px-8 md:px-[200px] mt-8">
          ...
          <img src={IF+post.photo} className="w-full mx-auto mt-8" alt="Nature"/>
          <p mx-auto mt-8>{post.desc}</p>
         ...
         <div className="w-full flex flex-col mt-4 md:flex-row">
            ...
            <button onClick={postComment} className="bg-black text-white px-2 py-2 md:w-[20%] mt-4 md:mt-0 text-sm">Add Comment</button>
